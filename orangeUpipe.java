 ...
 *
 * <P>
 * Make sure to set all sources using the setters before running process().
 *
 * @author GRIP
 */
public class orangeUpipe {
	...
	public void process() {
		...
		int resizeImageWidth = 720;
		int resizeImageHeight = 480;
		...
		double[] hsvThresholdHue = { 0.0, 37.16723549488056 };
		double[] hsvThresholdSaturation = { 82.28999534182347, 254.6108144544515 };
		double[] hsvThresholdValue = { 158.22841726618705, 255.0 };
		...
		double[] filterContoursSolidity = { 32.37410071942446, 86.3481228668942 };
